...
Green Ball Privacy Policy

Green Ball "the App” provides [[DESCRIBE SERVICE APP PROVIDES]] "the Service" to merchants who use Shopify to power their stores. This Privacy Policy describes how personal information is collected, used, and shared when you install or use the App in connection with your Shopify-supported store.
...
You can opt out of targeted advertising by: Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance’s opt-out portal at: http://optout.aboutads.info/.
